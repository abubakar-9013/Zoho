//
//  Home_Search_TableViewCell.swift
//  Zoho
//
...
class Home_Search_TableViewCell: UITableViewCell {
    ...
    let leftImageView:UIImageView = {
        ...
        imgv.layer.cornerRadius = 20.autoSized
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        super.init(style: .subtitle, reuseIdentifier: "searchCell")
        ...
        NSLayoutConstraint.activate([
            ...
            leftView.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 8.autoSized),
            ...
            leftImageView.widthAnchor.constraint(equalToConstant: 40.autoSized),
            leftImageView.heightAnchor.constraint(equalToConstant: 40.autoSized),
